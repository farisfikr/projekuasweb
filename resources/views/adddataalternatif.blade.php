              ...
              <form method="POST" action="{{ url('/alternatif/store')}}" class="form-horizontal">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" name="kebutuhan" placeholder="Kebutuhan" required>
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="ketersediaan" class="col-sm-2 col-form-label">C2</label>
                    <div class="col-sm-10">
                      <input type="text" class="form-control" name="ketersediaan" placeholder="Ketersediaan" required>
                    </div>
                  </div>
                  <div class="form-group row">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" name="kualitas" placeholder="Kualitas" required>
                    </div>
                  </div>
                </div>
                <!-- /.card-body -->
